...
public:
    ...
    bool saveResult(const std::string & instanceName, const std::string &algoName, const std::string& filename, std::size_t size, double cpuTime, const Result& result) const;
};
